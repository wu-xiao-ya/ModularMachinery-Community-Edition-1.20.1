...
import hellfirepvp.modularmachinery.common.block.BlockFluidProcessorHatch;
...
import static hellfirepvp.modularmachinery.common.lib.BlocksMM.fluidProcessorHatch;
...
public class RegistryBlocks {
    ...
    private static void warmCustomHatchRegistryCache() {
        try {
            Class<?> registryClass = Class.forName("com.fushu.mmceguiext.common.registry.CustomHatchRegistry");
            registryClass.getMethod("getCached").invoke(null);
        } catch (ClassNotFoundException ignored) {
            // mmce-gui-ext is not on this compile/runtime path.
        } catch (ReflectiveOperationException e) {
            ModularMachinery.log.warn("Failed to warm custom hatch registry cache", e);
        }
    }
    ...
    private static void registerBlocks() {
        ...
        fluidProcessorHatch = prepareRegister(new BlockFluidProcessorHatch());
        prepareItemBlockRegister(fluidProcessorHatch);
