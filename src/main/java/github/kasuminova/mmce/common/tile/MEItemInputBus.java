...
public class MEItemInputBus extends MEItemBus implements SettingsTransfer {
    ...
    public IOInventory getConfigInventory() {
        ensureSlotTrackingCapacity(configInventory.getSlots());
    ...
    private boolean needsUpdate() {
        int slotCount = Math.min(inventory.getSlots(), configInventory.getSlots());
        ensureSlotTrackingCapacity(slotCount);
    ...
    public TickRateModulation tickingRequest(@Nonnull final IGridNode node, final int ticksSinceLastCall) {
        ...
        try {
            ...
            int slotBound = Math.min(inventory.getSlots(), configInventory.getSlots());
            ensureSlotTrackingCapacity(slotBound);
